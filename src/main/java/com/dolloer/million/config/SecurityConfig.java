...
import com.dolloer.million.security.JwtSecurityFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .cors(cors -> cors.configurationSource(request -> {
                    ...
                    configuration.setAllowedOrigins(Arrays.asList("https://milliondollarmanclubfront.onrender.com","http://localhost:3000"));
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/signin", "/signup","/stock/price","/stock/candle","/ping").permitAll()
